...
# importing SDR data
sdr_16 <- read_excel(
  "SDR_Data_Release_2016_v01.xlsx",
...
# importing voa data
voa_16 <- read_excel(
  "Publication_AllTables_17112016.xlsx",
  sheet = "Table 2.7",
  range = "B7:I378"
)
...
# importing SDR data
sdr_17 <- read_excel(
  "SDR_Data_Release_2017_FINAL_v01.0.xlsx",
...
# importing voa data
voa_17 <- read_excel(
  "Publication_AllTables_14122017.xlsx",
  sheet = "Table2.7 ",
  range = "B7:I378"
)
...
# importing SDR data
sdr_18 <- read_excel(
  "SDR_Data_Release_2018_FINAL_v1.2.xlsx",
...
# importing voa data
voa_18 <- read_excel(
  "Publication_AllTables_13122018.xlsx",
  sheet = "Table2.7",
  range = "B7:I378"
)
...
# importing SDR data
sdr_19 <- read_excel(
  "SDR_Data_Release_2019_v1.2_Full_Data.xlsx",
...
# importing voa data
voa_19 <- read_excel(
  "privaterentalmarketstatistics13122019.xlsx",
  sheet = "Table2.7",
  range = "B7:I378"
)
...
# importing SDR data
sdr_20 <- read_excel(
  "SDR_Data_Release_2020_Full_Data_v1.1_-_FINAL.xlsx",
...
# importing voa data
voa_20 <- read_excel(
  "privaterentalmarketstatistics11122020.xlsx",
  sheet = "Table2.7",
  range = "B7:I364"
)
...
save(rent_gap_full, file = "rent_gap_full.Rdata")
